...
# CONFIG
# --------------------------
PATH = "PFC_filtered_apoe_QC.h5ad"
...
CHECKPOINT_CSV = "MIT_scrublet_results_checkpoint.csv"
...
if __name__ == "__main__":
    ...
    out_obs_csv = "mit_doublets_obs.csv"
    ...
    print("Loading AnnData fully into memory...")
    adata = adata.to_memory()
    print("Creating singlets-only AnnData and saving...")
    adata_singlets = adata[adata.obs["predicted_doublets"] == False, :].copy()
    adata_singlets.write_h5ad("PFC_filtered_apoe_singlets.h5ad")
    print("Saved singlets AnnData → PFC_filtered_apoe_singlets.h5ad")
