...
# CONFIG
# --------------------------
PATH = "seaad_filtered_apoe.h5ad"

PATIENT_COL = "Donor ID"       # <- exact column name in .obs
...
CHECKPOINT_CSV = "seaad_scrublet_results_checkpoint.csv"
...
if __name__ == "__main__":
    ...
    out_obs_csv = "seaad_doublets_obs.csv"
    ...
    adata_singlets.write_h5ad("seaad_filtered_apoe_singlets.h5ad")
    print("Saved singlets AnnData → seaad_filtered_apoe_singlets.h5ad")
